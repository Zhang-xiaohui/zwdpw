			...
			<div class="label-foot">
				...
				<div>
					...
					<h3 class="composition-name">{{ContainerData.NAME}}</h3>
					   ...
					   <router-link class="router-css" :to="{path:'remark' , query:{id:ContainerData.id,content:ContainerData.CONTENT,time:ContainerData.TIME,name:ContainerData.NAME,teacherName:ContainerData.CREATOR}}">
						<div class="label-body" v-html='ContainerData.CONTENT'>
						</div>	
					   </router-link>
